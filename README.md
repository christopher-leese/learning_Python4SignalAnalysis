# learning_PySDR
Learning and experimenting with PySDR for a synthetic burst detector / SigMF annotator project... Primarily notes and exercise records. Folders separate topics in order of coverage.
